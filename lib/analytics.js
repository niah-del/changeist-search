...
export function geoFromRequest(req) {
  return {
    country: req.headers['x-vercel-ip-country'] ? req.headers['x-vercel-ip-country'].toUpperCase() : null,
    region:  req.headers['x-vercel-ip-country-region'] ? req.headers['x-vercel-ip-country-region'].toUpperCase() : null,
